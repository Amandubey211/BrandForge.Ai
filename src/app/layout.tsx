...
export const metadata: Metadata = {
  ...
  description: "A creative playground to generate polished, on-brand social media posts for event vendors using a multimodal AI. A take-home assignment by Aman Dubey.",
  ...
  twitter: {
    ...
    description: "Generate stunning social posts with an AI creative director. Built with Next.js, Gemini, and Framer Motion.",
  ...
  keywords: ['Aman Dubey', 'AI', 'Generative AI', 'Next.js', 'React', 'TypeScript', 'PartyHub', 'Social Media', 'Gemini'],
